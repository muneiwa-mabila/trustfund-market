...
WHERE seller_items.product_status='Approved' AND seller_items.product_category='Women'
...
<div class="page-wrapper">
  <div class="breadcrumb-nav"><a href="index.php">Home</a> → <span>Women</span></div>
  <div class="title-row">
    <h1>Women</h1>
  ...
  <div class="deal-card">
    <div class="deal-image">
      ...
      <a href="women.php?wishlist=<?php echo $product['id']; ?>" class="heart-btn <?= $inWishlist ? 'active' : 'inactive'; ?>"><i class="fa-<?= $inWishlist ? 'solid' : 'regular'; ?> fa-heart"></i></a>
      <?php endif; ?>
    </div>
  ...
  <?php endwhile; ?>
  <?php else: ?>
    <div class="empty-box"><i class="fa-solid fa-box-open"></i><h2>No Women's Products Yet</h2><p>Check back soon<?php if(!$currentUser || $currentUser['seller_status'] != 'approved'): ?> or <a href="application.php" style="color:#a65cc5;">become a seller</a><?php endif; ?>.</p></div>
  <?php endif; ?>
  </div>
</div>
</body>
