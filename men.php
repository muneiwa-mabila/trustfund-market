...
/* PRODUCTS + SELLER NAME + AVG RATING */
$query = "
...
WHERE seller_items.product_status='Approved' AND seller_items.product_category='Men'
...
<div class="header-container">
  ...
  <nav class="header-nav">
    ...
    <a href="wishlist.php" style="position:relative;">
      &#9825;
      <?php if($wishlistCount > 0): ?><span style="position:absolute;top:-8px;right:-10px;background:#a65cc5;color:white;border-radius:50%;width:16px;height:16px;font-size:10px;display:flex;align-items:center;justify-content:center;"><?php echo $wishlistCount; ?></span><?php endif; ?>
    </a>
    <a href="cart.php" style="position:relative;">
      &#128722;
      <?php if($cartCount > 0): ?><span style="position:absolute;top:-8px;right:-10px;background:#a65cc5;color:white;border-radius:50%;width:16px;height:16px;font-size:10px;display:flex;align-items:center;justify-content:center;"><?php echo $cartCount; ?></span><?php endif; ?>
    </a>
  </nav>
</div>
</header>
...
<div class="page-wrapper">
  ...
  <div class="deal-card">
    ...
    <div class="deal-image">
      ...
      <a href="mens.php?wishlist=<?php echo $product['id']; ?>"
    ...
    <div class="deal-info">
      ...
      <div class="deal-price">
        R<?php echo number_format((float)preg_replace('/[^0-9.]/', '', $product['product_price'])); ?>
      </div>
  ...
  <?php else: ?>
    <div class="empty-box">
      ...
      <h2>No Men's Products Yet</h2>
      <p>Check back soon<?php if(!$currentUser || $currentUser['seller_status'] != 'approved'): ?> or <a href="application.php" style="color:#a65cc5;">become a seller</a><?php endif; ?>.</p>
    </div>
  <?php endif; ?>
