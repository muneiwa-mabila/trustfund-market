...
WHERE seller_items.product_status='Approved' AND seller_items.product_category='Hair'
...
<title>Hair Services | TrustFund</title>
...
<div class="page-wrapper">
  <div class="breadcrumb-nav"><a href="index.php">Home</a> → <span>Hair</span></div>
  <div class="title-row">
    <h1>Hair Services</h1>
    <div class="deals-count"><?php echo mysqli_num_rows($result); ?> Services</div>
  </div>
  ...
  <div class="deal-card">
    <div class="deal-image">
      ...
      <a href="hair.php?wishlist=<?php echo $product['id']; ?>" class="heart-btn <?= $inWishlist ? 'active' : 'inactive'; ?>"><i class="fa-<?= $inWishlist ? 'solid' : 'regular'; ?> fa-heart"></i></a>
      <?php endif; ?>
    </div>
  ...
  <?php endwhile; ?>
  <?php else: ?>
    <div class="empty-box"><i class="fa-solid fa-scissors"></i><h2>No Hair Services Yet</h2><p>Check back soon<?php if(!$currentUser || $currentUser['seller_status'] != 'approved'): ?> or <a href="application.php" style="color:#a65cc5;">become a seller</a><?php endif; ?>.</p></div>
  <?php endif; ?>
  </div>
</div>
</body>
